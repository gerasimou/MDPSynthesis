...
module M
	...
	[select_xloc2]	x=2->0.445387194055:(x'=8)+0.554612805945:(x'=20);
	[select_xloc3]	x=3->0.721540032341:(x'=12)+0.278459967659:(x'=24);
	[]	x=4->1:(x'=46);
	...
	[select_xloc1]	x=6->0.002106053351:(x'=4)+0.997893946649:(x'=16);
	[select_xloc3]	x=7->0.721540032341:(x'=12)+0.278459967659:(x'=24);
	[]	x=8->1:(x'=47);
	[select_xloc1]	x=9&o9=0->0.002106053351:(x'=2)+0.997893946649:(x'=14);
	[select_xloc2]	x=9&o9=1->0.445387194055:(x'=6)+0.554612805945:(x'=18);
	[select_xloc1]	x=10->0.002106053351:(x'=4)+0.997893946649:(x'=16);
	[select_xloc2]	x=11->0.445387194055:(x'=8)+0.554612805945:(x'=20);
	[]	x=12->1:(x'=48);
